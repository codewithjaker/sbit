...
import { fetchAllGalleryItems } from "@/services/gallery.service";
...
export default function GalleryPage() {
  ...
  // Dynamic categories based on tags
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Explore moments, resources, and success stories from Skill Based IT
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            {filteredItems.map((item) => {
              ...
              return (
                <Card
                  key={item.id}
                  className="group hover:shadow-xl transition-all duration-300 border-2 hover:border-orange-200 overflow-hidden flex flex-col h-full pt-0"
                >
                  {/* Image Container */}
                  <div
                    className="relative w-full pt-[56.25%] bg-gradient-to-br from-orange-100 to-amber-100 overflow-hidden cursor-pointer"
        ...
        {/* CTA Section */}
        <Card className="mt-12 bg-gradient-to-r from-orange-600 to-amber-600 text-white border-0">
