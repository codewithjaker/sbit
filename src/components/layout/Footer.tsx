...
export default function Footer() {
  ...
  // Do not render the footer until the API data is available
  if (!content) {
    return null;
  }
  ...
  const socialLinks = [
    { field: content.facebook, icon: socialIconMap.facebook, label: "Facebook" },
    { field: content.instagram, icon: socialIconMap.instagram, label: "Instagram" },
    { field: content.twitter, icon: socialIconMap.twitter, label: "Twitter" },
    { field: content.youtube, icon: socialIconMap.youtube, label: "YouTube" },
  ]
  ...
  // Build contact items from API data
  const contactItems = [
    { field: content.address, icon: MapPin, id: "address" },
    { field: content.phone, icon: Phone, id: "phone" },
    { field: content.support_phone, icon: Phone, id: "support-phone" },
    { field: content.email, icon: Mail, id: "email" },
  ]
    .filter((item) => item.field)
    .map((item) => ({
      id: item.id,
  ...
  return (
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-4">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p>&copy; {new Date().getFullYear()} Skill Based IT. All rights reserved.</p>
            <div className="flex space-x-6 mt-4 md:mt-0">
              <Link
                href="/privacy-policy"
                className="text-gray-400 hover:text-white transition-colors text-sm"
